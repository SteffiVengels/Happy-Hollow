class TinyMonster extends MovableObject {
    ...
    IMAGES_DEAD = [
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/death/tile000.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/death/tile001.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/death/tile002.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/death/tile003.png'
    ];
    IMAGES_ATTACK = [
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/attack/tile000.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/attack/tile001.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/attack/tile002.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/attack/tile003.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/attack/tile004.png',
        './assets/img/tiny-monsters-pixel-art-pack/5 Tiny/attack/tile005.png'
    ]
    offset = {
        top: 0,
        left: 5,
